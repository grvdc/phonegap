 ...
 */
app.controller('projectCtrl', function($scope,$ionicPopup,$state,$stateParams,AreaService,projectInfo,AuthenticationService,ProjectService, OccupantTypeService, AddressTypeService, ContractTypeService,IonicClosePopupService) {
  ...
  AreaService.getAllAreaByProject(projectId).then(function (data){
...
$state.go("menu.AreaAssignment",{projectId:projectId}, {'reload': true});
}
